...
function validMove(move, game) {
	...
	if(game.board[move.CoordX+1][move.CoordY]&&game.board[move.CoordX-1][move.CoordY]&&game.board[move.CoordX][move.CoordY+1]&&game.board[move.CoordX+1][move.CoordY-1]
}
